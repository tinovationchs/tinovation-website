...
<svelte:head>
  <title>
    {`${data.metadata.title} - Resources`}
  </title>
  <meta property="og:title" content={`${data.metadata.title} - Resources`} />
  ...
  <meta property="twitter:title" content={`${data.metadata.title} - Resources`} />
  <meta
...
<div class="flex flex-row justify-center">
  <main
    class="md:w-max-[30rem] z-10 flex w-full flex-col gap-4 px-6 pb-10 pt-16 font-sans text-lg font-light text-retro-white md:w-[42rem] md:pt-20 lg:w-[52rem]">
    <div class="flex flex-row justify-center">
