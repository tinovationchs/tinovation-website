...
<div class="flex flex-col gap-2">
  <div class="mt-4 flex flex-row items-center gap-5">
    ...
    <a
      ...
      target="_blank"
      class=" flex h-12 w-12 items-center justify-center rounded-lg border-2 border-retro-white fill-retro-white transition duration-75 ease-in hover:border-red-500 hover:fill-red-500">
  ...
  {#if info.form_visible}
    ...
    transition duration-100 ease-in hover:-translate-y-0.5 hover:border-purple-400 hover:stroke-purple-300 hover:text-purple-300 hover:opacity-90 hover:shadow-lg hover:shadow-purple-400">
      ...
      <svg
        ...
        stroke-width="3"
        stroke="currentColor"
        class="inline-block h-4 w-4 translate-y-0.5 transition duration-[25ms] ease-in">
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
